...
const productSeeds: Array<Omit<ProductDetail, "images">> = [
  {
    ...
    imageTone: "green",
    shortDescription: "Proteína aislada de alta pureza para recuperación muscular.",
    description:
      "Fórmula pensada para sumar proteína de calidad sin cargar la digestión. Ideal para después de entrenar o para completar macros en días exigentes.",
    tags: ["25g proteína", "Bajo azúcar", "Sin TACC"],
    subcategorySlugs: ["whey-protein", "isolate"],
    price: 78900,
    rating: 4.8,
    reviews: 126,
    stock: 18,
  ...
  },
  {
    ...
    description:
      "Creatina monohidrato sin sabor para incorporar fácil a cualquier bebida. Un clásico efectivo cuando se toma todos los días.",
    tags: ["Micronizada", "Sin sabor", "300g"],
    subcategorySlugs: ["creatina"],
    price: 31200,
    rating: 4.9,
    reviews: 211,
    stock: 24,
  ...
  },
  {
    ...
    categoryName: "Creatina y pre",
    imageTone: "red",
    shortDescription: "Pre entreno con cafeína, beta alanina y citrulina.",
    description:
      "Un pre entreno directo al punto para sesiones intensas. Foco, energía y congestión sin convertir la fórmula en una ensalada de ingredientes.",
    tags: ["Cafeína", "Beta alanina", "Citrulina"],
    subcategorySlugs: ["pre-intra-entreno", "pre-entrenos"],
    price: 28000,
  ...
  },
  {
    ...
    imageTone: "blue",
    shortDescription: "Remera boxy fit para entrenar o usar todos los días.",
    description:
      "Remera de calce boxy con algodón pesado, cuello reforzado y estampa EntrenAR.",
    tags: ["Boxy fit", "Algodón", "Drop limitado"],
    subcategorySlugs: ["entreno"],
    price: 49999,
  ...
  },
  {
    ...
    description:
      "Barras con buen aporte proteico para tener en la mochila, la oficina o después del gimnasio.",
    tags: ["12 unidades", "Snack", "Chocolate"],
    subcategorySlugs: ["barras", "protein-bars"],
    price: 22800,
    rating: 4.4,
    reviews: 39,
    stock: 20,
  ...
  },
  {
    ...
    description:
      "Un shaker resistente para proteínas, creatina y bebidas intra entrenamiento.",
    tags: ["700ml", "BPA free", "Mezclador"],
    subcategorySlugs: ["shakers-y-botellas"],
    price: 8900,
    rating: 4.7,
    reviews: 74,
    stock: 32,
  ...
  },
  {
    ...
    categoryName: "Market",
    imageTone: "amber",
    shortDescription: "Salsa dulce sin azúcar para sumar sabor a tus comidas.",
    description: "Salsa de chocolate sin azúcar ideal para pancakes, frutas, yogures o snacks proteicos.",
    tags: ["Sin azúcar", "Chocolate", "335g"],
    subcategorySlugs: ["salsas"],
    price: 11372,
  ...
  },
  {
    ...
    imageTone: "blue",
    shortDescription: "Magnesio en cápsulas para soporte diario.",
    description: "Citrato de magnesio para acompañar recuperación, descanso y bienestar general.",
    tags: ["60 caps", "Magnesio", "Diario"],
    subcategorySlugs: ["magnesio", "stress-sueno"],
    price: 13940,
  ...
  },
  {
    ...
    categoryName: "Market",
    imageTone: "black",
    shortDescription: "Mezcla para pancakes proteicos rápidos.",
    description: "Preparación proteica para resolver desayunos o meriendas con buen aporte nutricional.",
    tags: ["400g", "Proteico", "Pancakes"],
    subcategorySlugs: ["polvos-mezclas", "protein-foods"],
    price: 14000,
  ...
  },
  {
    ...
    description: "Barras proteicas prácticas para llevar a entrenar, trabajar o estudiar.",
  ...
  },
  {
    ...
    subcategorySlugs: ["barras", "plant-protein"],
    price: 4200,
    compareAtPrice: 5250,
    rating: 4.3,
    reviews: 18,
  ...
  },
  {
    ...
    description: "Alfajor con aporte proteico para quienes buscan una opción dulce más funcional.",
    tags: ["Alfajor", "Proteico", "Snack"],
    subcategorySlugs: ["alfajor"],
    price: 3100,
    compareAtPrice: 3900,
    rating: 4.4,
    reviews: 22,
  ...
  },
  {
    ...
    categoryName: "Market",
    imageTone: "red",
    shortDescription: "Mix de frutos secos para energía rápida.",
    description: "Mix de frutos secos seleccionado para sumar grasas buenas y energía durante el día.",
    tags: ["500g", "Frutos secos", "Energía"],
    subcategorySlugs: ["frutos-secos"],
    price: 9200,
  ...
  },
  {
    ...
    description: "Fish oil en cápsulas blandas para acompañar salud cardiovascular y recuperación.",
    tags: ["Omega 3", "60 softgels", "Diario"],
    subcategorySlugs: ["fish-oil-omegas", "omega"],
    price: 15800,
