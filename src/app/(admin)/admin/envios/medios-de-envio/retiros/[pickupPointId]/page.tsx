...
export default function PickupPointConfigPage({ params }: { params: Promise<{ pickupPointId: string }> }) {
  ...
  return <div className="mx-auto grid w-full max-w-5xl gap-5"><AdminPageHeader tag="Envíos" title={pickupPointId === "nuevo" ? "Nuevo punto de retiro" : pickupPoint.name} description="Configurá dirección, horarios, costo y cobertura." backLink={{ href: "/admin/envios/medios-de-envio", label: "Volver" }} /><PickupPointForm pickupPoint={pickupPoint} onSubmit={handleSubmit} /></div>;
}
