...
export function ProviderConfigForm({ onSubmit, provider }: ProviderConfigFormProps) {
  ...
  const { formState: { errors, isSubmitting }, handleSubmit } = methods;
