...
export function ScheduleSection() {
  ...
  })}<div aria-invalid={errors.schedule ? true : undefined} aria-describedby={typeof errors.schedule?.message === "string" ? "pickup-schedule-error" : undefined} data-error-section="schedule" />{typeof errors.schedule?.message === "string" ? <p id="pickup-schedule-error" className="text-xs font-medium text-sale">{errors.schedule.message}</p> : null}</div></PickupSection>;
}
